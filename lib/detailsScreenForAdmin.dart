...
class DetailsScreenForAdmin extends StatefulWidget {
  static String id ='DetailsScreenForAdmin';
  String details;
  String type;
  String price;
  ...
  DetailsScreenForAdmin(
      ...
      this.imgList});
  @override
  _DetailsScreenForAdminState createState() => _DetailsScreenForAdminState();
}

class _DetailsScreenForAdminState extends State<DetailsScreenForAdmin> {
  List image;
  @override
